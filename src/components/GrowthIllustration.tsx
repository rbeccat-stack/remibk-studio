export default function GrowthIllustration() {
  return (
    <div className="w-full max-w-[400px] sm:max-w-[440px] mx-auto md:ml-auto md:mr-0">
      <svg
        viewBox="0 0 440 376"
        role="img"
      ...
      >
        ...
        <g transform="translate(0 6)">
          ...
          <g className="gh-float-slow">
            <rect x="166" y="164" width="40" height="22" rx="11" fill="var(--color-sage)" />
            <text
              x="186"
              y="179"
              textAnchor="middle"
          ...
          <g stroke="var(--color-terracotta)" strokeWidth="2.5" strokeLinecap="round" strokeOpacity="0.75">
